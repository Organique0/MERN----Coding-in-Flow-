...
exports.updateNote = exports.getNotes = exports.getNote = exports.deleteNote = exports.createNote = void 0;
var _note = _interopRequireDefault(require("../models/note"));
var _httpErrors = _interopRequireDefault(require("http-errors"));
var _mongoose = _interopRequireDefault(require("mongoose"));
var _assertIsDefined = require("../util/assertIsDefined");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          (0, _assertIsDefined.assertIsDefined)(authenticatedUserId);
          _context.next = 5;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.prev = 2;
          (0, _assertIsDefined.assertIsDefined)(authenticatedUserId);
          if (_mongoose["default"].isValidObjectId(noteId)) {
            _context2.next = 6;
            break;
          }
          throw (0, _httpErrors["default"])(400, "Invalid note id");
        case 6:
          _context2.next = 8;
          return _note["default"].findById(noteId).exec();
        case 8:
          note = _context2.sent;
          if (note) {
            _context2.next = 11;
          ...
          throw (0, _httpErrors["default"])(404, "Note not found");
        case 11:
          if (note.userId.equals(authenticatedUserId)) {
            _context2.next = 13;
            break;
          }
          throw (0, _httpErrors["default"])(401, "You cannot access this note");
        case 13:
...
var createNote = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          throw (0, _httpErrors["default"])(400, "Note must hava a title");
        case 7:
          _context3.next = 9;
  ...
  return function createNote(_x7, _x8, _x9) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 15:
          ...
          throw (0, _httpErrors["default"])(404, "You cannot access this note");
        case 17:
          note.title = newTitle;
          note.text = newText;
          _context4.next = 21;
